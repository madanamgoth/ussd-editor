...
const FLOW_SCENARIOS = [
  {
    ...
    "steps": [
      ...
      {
        "input": "*",
        "storeAttribute": "SENDMONEYAMOUNT",
        "nodeType": "INPUT",
        "nextNodeType": "INPUT",
        "isActionNode": false,
        "templateId": null
      ...
      {
        "input": "*",
        "storeAttribute": "SENDMONEYRECIVERMSISDN",
        "nodeType": "INPUT",
        "nextNodeType": "ACTION",
        "isActionNode": true,
        "templateId": null
    ...
    "assertions": [
      {
        "expectedResponse": "Please enter your 4-digit PIN:",
        "nodeType": "INPUT",
      ...
      {
        "expectedResponse": "Select Service:\n1. Send Money\n2. Pay Bills\n3. Check Balance",
        "nodeType": "MENU",
      ...
      {
        "expectedResponse": "Enter amount to send:",
        "nodeType": "INPUT",
        "assertionType": "input_prompt",
        "isStrictMatch": false,
        "isDynamicContent": false
      ...
      {
        "expectedResponse": "Enter recipient phone number:",
        "nodeType": "INPUT",
        "assertionType": "input_prompt",
        "isStrictMatch": false,
        "isDynamicContent": false
      ...
      {
        "expectedResponse": "Transaction completed successfully! Transaction ID: TXN123456",
        "nodeType": "END",
...
function validateResponse(response, assertion, stepIndex, scenarioName) {
  ...
  if (response.body && assertion.expectedResponse) {
    ...
    if (assertion.assertionType === 'dynamic_menu') {
      ...
      checks['exact content match'] = (r) => {
        const cleanActual = r.body.trim().toLowerCase();
        const cleanExpected = assertion.expectedResponse.trim().toLowerCase();
