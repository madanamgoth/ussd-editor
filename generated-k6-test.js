...
const FLOW_SCENARIOS = [
  {
    ...
    "assertions": [
      ...
      {
        "expectedResponse": "Please enter your amount:",
        "assertionType": "input_prompt",
        "isStrictMatch": false,
        "isDynamicContent": false
      },
      {
        "expectedResponse": "Thank you for using our service! transaction successful with :sendMoneytransactionId",
